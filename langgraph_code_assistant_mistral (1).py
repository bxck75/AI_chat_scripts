...
Original file is located at
    https://colab.research.google.com/github/langchain-ai/langgraph/blob/main/examples/code_assistant/langgraph_code_assistant_mistral.ipynb
...
huggingface_api_key = userdata.get('HF_WRITE') # Ensure this is set
